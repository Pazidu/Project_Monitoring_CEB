...
export const MOCK_PROJECT_DETAILS = {
  ...
  overview: {
    ...
    scope: [
      "Route trfrfrf survey, detailed design, and required approvals / clearances",
    ...
    stakeholders: [
      {
        role: "Project",
        title: "Director 1",
        email: "director1@edl.lk",
        phone: "0785855555",
      },
      {
        role: "Project",
        title: "Director 2",
        email: "director2@edl.lk",
        phone: "078555",
      },
      {
        role: "Project Manager 1",
        title: "Manager",
        email: "manager1@edl.lk",
        phone: "078585553",
      },
      {
        role: "Project Manager 2",
        title: "Manager",
        email: "manager2@edl.lk",
        phone: "0757585841",
      },
      {
        role: "Contractor 1",
        title: "Contractor",
        email: "contractor1@edl.lk",
        phone: "0757585841",
      },
      {
        role: "Contractor 2",
        title: "Contractor",
        email: "contractor2@edl.lk",
        phone: "0757585841",
      },
      {
        role: "Consultant 1",
        title: "Consultant",
        email: "consultant1@edl.lk",
        phone: "0757585841",
      },
      {
        role: "Consultant 2",
        title: "Consultant",
        email: "consultant2@edl.lk",
        phone: "0757585841",
      },
    ],
    currencies: [
